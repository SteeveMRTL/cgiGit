...
<div class="super_container">
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start trans_400">
						...
						<nav class="main_nav">
							<ul class="d-flex flex-row align-items-center justify-content-start">
								...
								<li class="active"><a href="pSelectionPanier.jsp">Commander</a></li>
	...
	<c:choose>
	<c:when test="${client!=null}">
	<form class="form-inline" action="SSelectionPanier" method="post">
		<div class="services">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="section_title_container">
							...
							<div class="section_title">Nos activités</div>
						</div>
					</div>
				</div>
				<div class="row services_row">
					...
					<div class="col-xl-4 col-md-6 service_col">
						<div class="service">
							<div class="service_title_container d-flex flex-row align-items-center justify-content-start">
								...
								<div class="service_title">Activités:</div>
							</div>
							<div class="service_text">
								<select class="form-control" id="select" name="sport">
									<c:forEach var="sport" items="${sports}">
										<option><c:out value="${sport.nom}" /></option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="col-xl-4 col-md-6 service_col">
						<div class="service">
							...
							<div class="service_text">
								<input type="number" id="quantite" name="quantite" min="0" max="12" value="1"> mois d'abonnement
								<button type="submit" class="contact_button button">Ajouter au panier</button>
							</div>
						</div>
					</div>
		...
		<br>
		<a href="SValidationPanier" ><button type="button" class="contact_button button">Valider le panier</button></a>
	</c:when>
		<c:otherwise>
			<div class="services">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="section_title_container">
							<div class="section_subtitle">Bienvenue sur sportfit</div>
							<div class="section_title">Vous n'êtes pas connecté(e)</div>
						</div>
					</div>
				</div>
				<div class="row services_row">
					...
					<div class="col-xl-4 col-md-6 service_col">
						<div class="service">
							<div class="service_text">
								<a href="pAuthentification.jsp"><button class="contact_button button">Se connecter</button></a>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-md-6 service_col">
						<div class="service">
							<div class="service_text">
								<a href="pInscription.jsp"><button class="contact_button button">S'inscrire</button></a>
							</div>
						</div>
					</div>
			</div>
			...
			<tbody>
				<c:forEach var="ligne" items="${panier.lignes}">
					<tr>
						...
						<td><c:out value="${ligne.article.prix}" /></td>
						<td><c:out value="${ligne.sousTotal}" /></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
