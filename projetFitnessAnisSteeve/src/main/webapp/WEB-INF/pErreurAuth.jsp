...
<html lang="en">
<head>
<title>Problème d'authentification</title>
<meta charset="utf-8">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Il semble que vous ne soyez pas encore inscrit(e)</div>
					</div>
				</div>
			</div>
			<div class="row services_row">
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pInscription.jsp" ><button type="button" class="contact_button button">S'inscrire</button></a>
						</div>
					</div>
				</div>
