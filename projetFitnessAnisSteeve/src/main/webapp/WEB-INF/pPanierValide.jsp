			...
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Votre commande a bien été prise en compte</div>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pSelectionPanier.jsp"><button type="button" class="contact_button button">Autre commande</button></a>
						</div>
					</div>
				</div>
