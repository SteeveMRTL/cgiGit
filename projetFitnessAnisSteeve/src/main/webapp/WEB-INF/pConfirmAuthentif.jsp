			...
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Bienvenue dans votre espace <c:out value="${client.prenom}"/></div>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pSelectionPanier.jsp"><button type="button" class="contact_button button">Choix des activités</button></a>
						</div>
					</div>
				</div>
