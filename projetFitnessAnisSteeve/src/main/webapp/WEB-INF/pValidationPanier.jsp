		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Avez-vous fini votre sélection ?</div>
					</div>
				</div>
			</div>
			<div class="row services_row">
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pSelectionPanier.jsp" ><button type="button" class="contact_button button">Modifier le panier</button></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="ServletCommande" ><button type="button" class="contact_button button">Valider le panier</button></a>
						</div>
					</div>
				</div>
...
<script src="js/services.js"></script>
		...
		<a href="pSelectionPanier.jsp" ><button type="button" class="btn btn-default">Modifier le panier</button></a>
		<a href="ServletCommande" ><button type="button" class="btn btn-default">Valider le panier</button></a>
	</div>
