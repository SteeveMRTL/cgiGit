...
<html lang="en">
<head>
<title>Ce client existe déjà</title>
<meta charset="utf-8">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container">
						...
						<div class="section_title">Un client avec cet identifiant existe déjà</div>
					</div>
				</div>
			</div>
			<div class="row services_row">
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pAuthentification.jsp" ><button type="button" class="contact_button button">S'identifier</button></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4 col-md-6 service_col">
					<div class="service">
						<div class="service_text">
							<a href="pInscription.jsp" ><button type="button" class="contact_button button">Se réinscrire</button></a>
						</div>
					</div>
				</div>
