				...
				<div class="col">
					<div class="boxes_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
						...
						<div class="box">
							...
							<div class="box_text">
								<p>un esprit sain dans un corps sain ! Le crossfit vous permet d'assainir tout votre corps en une seule activité.</p>
							</div>
						...
						<div class="box">
							...
							<div class="box_text">
								<p>Une excellente manière de travailler le cardio, la base de tous les sports, tout en préservant vos articulations.</p>
							</div>
							<div class="box_link_container">
								<a href="#"><div class="box_link d-flex flex-column align-items-center justify-content-center trans_200"><div>+</div></div></a>
							</div>
						...
						<div class="box">
							...
							<div class="box_text">
								<p>Une bonne acitivité physique brûle beaucoup de calories. Nos conseillers vous aideront à couvrir vos besoins. </p>
							</div>
							<div class="box_link_container">
								<a href="#"><div class="box_link d-flex flex-column align-items-center justify-content-center trans_200"><div>+</div></div></a>
							</div>
				...
				<div class="col-lg-6">
					<div class="about_content">
						<div class="section_title_container">
							...
							<div class="section_title">Découvrez <span>Sportfit</span></div>
						</div>
						<div class="text_highlight">SportFIT abaisse les barrières entre vous et le sport.</div>
						<div class="about_text">
								<p>À une heure où chacun se préoccupe de sa santé, faire du sport est l'une des meilleures décisions que vous puissiez prendre.<br>
								Pourtant il est parfois difficile de s'inscrire à plus d'une activité sportive, ce qui nous fait repousser à demain nos inscriptions. Sportfit propose une plateforme centralisée de gestion de vos abonnements sportifs, ainsi qu'un suivi personnalisé. <br>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="section_title_container">
						<div class="section_subtitle">bienvenue sur sportfit</div>
						<div class="section_title">Témoignages</div>
					</div>
					...
					<div class="test test_1 d-flex flex-row align-items-start justify-content-start">
						...
						<div class="test_content">
							...
							<div class="test_text">
								<p>Grâce à sportFIT je prends plus soin de mon corps sans me prendre la tête. Seul bémol : le beau gosse de Martinique qui nous entraînait n'est pas célibataire.</p>
							</div>
				...
				<div class="col-lg-6">
					...
					<div class="test d-flex flex-row align-items-start justify-content-start">
						...
						<div class="test_content">
							...
							<div class="test_text">
								<p>SportFIT a changé ma vie. J'hésitais à me mettre au sport, grâce à la faciltié d'utilisation de SportFIT je m'y suis enfin mis. J'ai trouvé une femme grâce à mon regain d'assurance et mon corps beaucoup plus sain.</p>
							</div>
							<div class="rating rating_4 test_rating"><i></i><i></i><i></i><i></i><i></i></div>
						</div>
					</div>
					...
					<div class="test d-flex flex-row align-items-start justify-content-start">
						...
						<div class="test_content">
							...
							<div class="test_title">cliente</div>
							<div class="test_text">
								<p>Ça faisait des années que j'avais décidé de m'inscrire au judo et au crossfit, mais la difficulté de gérer les deux inscriptions m'arrêtait avant même d'entrer dans la salle. SportFIT m'a permis de m'y mettre et j'adore ça.</p>
							</div>
							<div class="rating rating_4 test_rating"><i></i><i></i><i></i><i></i><i></i></div>
						</div>
					</div>
