					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start trans_400">
						...
						<nav class="main_nav">
							<ul class="d-flex flex-row align-items-center justify-content-start">
								...
								<li class="active"><a href="pInscription.jsp">Inscription</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="contact_content">
						...
						<div class="contact_text">
							<p>Sélectionnez les sports que vous voulez pratiquer, et la durée de votre abonnement.</p>
						</div>
				...
				<div class="col-lg-8 contact_col">
					...
					<div class="contact_form_container">
						<form action="SInscription" method="post" id="contact_form" class="contact_form">
							<div class="row">
								<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="input_item"><input type="text" class="contact_input trans_200" placeholder="Nom" required="required" name="nom"></div>
								</div>
								<div class="col-lg-6">
									<div class="input_item"><input type="text" class="contact_input trans_200" placeholder="Prénom" required="required" name="prenom"></div>
								</div>
							</div>
									<div class="input_item"><input type="email" class="contact_input trans_200" placeholder="E-mail" required="required"></div>
							<button type="submit" class="contact_button button">Inscription</button>
						</form>
					</div>
				</div>
